    ...
    <head>
        ...
        <script>
            function submitForm() {
                ...
                if (document.querySelector("#addButton").value==="Aggiungi dipendente") document.dataForm.action.value="WorkerController.addWorker";
                else document.dataForm.action.value="WorkerController.updateWorker";
